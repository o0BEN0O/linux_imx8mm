...
#define MCP25XXFD_CAN_FLTCON_FLTEN(x) (BIT(7) << 8 * ((x) & 0x3))
#define MCP25XXFD_CAN_FLTCON_FLT_MASK(x) (GENMASK(7, 0) << (8 * ((x) & 0x3)))
#define MCP25XXFD_CAN_FLTCON_FBP(x, fifo) ((fifo) << 8 * ((x) & 0x3))

#define MCP25XXFD_CAN_FLTOBJ(x) (0x1f0 + 0x8 * (x))
...
#define MCP25XXFD_CAN_FLTMASK(x) (0x1f4 + 0x8 * (x))
